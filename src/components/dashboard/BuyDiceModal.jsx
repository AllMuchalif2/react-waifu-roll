...
export default function BuyDiceModal({
  ...
  return (
    <div className="fixed inset-0 bg-primary/80 backdrop-blur-sm z-100 flex items-center justify-center p-6 animate-fade-in">
      <div className="card-neo w-full max-w-sm bg-text-dark border-primary animate-zoom-in">
        <div className="flex flex-col items-center text-center">
          <div className="w-20 h-20 bg-primary/10 rounded-full flex items-center justify-center mb-4 border-2 border-primary text-primary">
          ...
          <div className="w-full bg-main p-4 rounded-2xl border-2 border-primary mb-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-8 h-8 rounded-lg border-2 border-text-dark flex items-center justify-center font-black hover:bg-primary hover:text-white transition-colors"
                >
                  -
                </button>
                <input
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg border-2 border-text-dark flex items-center justify-center font-black hover:bg-primary hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                >
                  +
                </button>
              </div>
